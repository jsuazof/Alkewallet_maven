...
public class MonedaDolarTest {
    ...
    public void testGetNombre() {
        MonedaDolar monedaDolar = new MonedaDolar("MonedaDolar", "$", "Dolares", 1.0);
    ...
    public void testGetSimbol() {
    	MonedaDolar monedaDolar = new MonedaDolar("MonedaDolar", "$", "Dolares", 1.0);
        assertEquals("$", monedaDolar.getSimbol());
    }

    @Test
    public void testSetNombre() {
        MonedaDolar monedaDolar = new MonedaDolar("Dolar", "$", "Dolares", 1.0);
