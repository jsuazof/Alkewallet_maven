...
public class Cuenta implements CuentaInterface {
    ...
    public void depositar(Double monto) {
        ...
        System.out.println();
        System.out.printf("*********************************%n");
        System.out.printf(" Deposito realizado con éxito    %n");
        System.out.printf("*********************************%n");
        System.out.printf(" %-10s : %-8s        %n", "Nombre", cliente.getNombre());
        System.out.printf(" %-10s : %-8s        %n", "N°Cuenta:", getCtaNumero());
        System.out.printf(" %-10s : %-8s        %n", "Saldo:", consultaSaldoRedondeado());
        System.out.printf("*********************************%n");
        System.out.printf("*********************************%n");
        System.out.println();
    ...
    public void retirar(Double monto) {
        ...
        System.out.println();
        System.out.printf("*********************************%n");
        System.out.printf("   Retiro realizado con éxito    %n");
        System.out.printf("*********************************%n");
        System.out.printf(" %-10s : %-8s        %n", "Nombre", cliente.getNombre());
        System.out.printf(" %-10s : %-8s        %n", "N°Cuenta:", getCtaNumero());
        System.out.printf(" %-10s : %-8s        %n", "Saldo:", consultaSaldoRedondeado());
    ...
    @Override
    public int consultaSaldoRedondeado() {
        return (int) Math.round(this.saldo);
    }
    ...
    public boolean validarRetiro(Double cantidad) {
        if (cantidad <= 0) {
            return false;
        } else return this.saldo >= cantidad;
    }
}
